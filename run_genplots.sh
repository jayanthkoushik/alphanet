...
for split in few base all; do
    sfile="${save_dir}/${split}_pred_changes_nn_semantic_imagenetlt_crt_rho_05${ext}"
    if check_does_not_exist "${sfile}"; then
